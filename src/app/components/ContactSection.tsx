      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center mb-12">
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-600">Ganpatsuthar887@gmail.com</p>
          </div>
          
          <div className="flex flex-col items-center">
            <Phone className="w-12 h-12 text-orange-400 mb-4" />
            <h3 className="font-medium mb-2">Call Us</h3>
            <p className="text-gray-600">+91 7990179679</p>
          </div>
          
          <div className="flex flex-col items-center">
            <Clock className="w-12 h-12 text-orange-400 mb-4" />
            <h3 className="font-medium mb-2">Our Timings</h3>
